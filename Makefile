# This Makefile is for the Text::Levenshtein::Damerau extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Text-Levenshtein-Damerau]
#     LICENSE => q[perl]
...
MAKE = make
FULLEXT = Text/Levenshtein/Damerau
BASEEXT = Damerau
PARENT_NAME = Text::Levenshtein
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Text/Levenshtein/Damerau.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Text/Levenshtein/Damerau.pm
...
TO_INST_PM = lib/Text/Levenshtein/Damerau.pm

PM_TO_BLIB = lib/Text/Levenshtein/Damerau.pm \
...
DISTVNAME = Text-Levenshtein-Damerau-0.07
...
manifypods : pure_all  \
	lib/Text/Levenshtein/Damerau.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Text/Levenshtein/Damerau.pm $(INST_MAN3DIR)/Text::Levenshtein::Damerau.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Damerau Levenshtein edit distance</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>ugexe &lt;F&lt;ug@skunkds.com&gt;&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Text/Levenshtein/Damerau.pm blib/lib/Text/Levenshtein/Damerau.pm 
